// To parse this data:
//
//   import { Convert, SearchImagesResponse } from "./file";
//
//   const searchImagesResponse = Convert.toSearchImagesResponse(json);
//
...
export class Convert {
    public static toSearchImagesResponse(json: string): SearchImagesResponse {
        return cast(JSON.parse(json), r("SearchImagesResponse"));
    }

    public static searchImagesResponseToJson(value: SearchImagesResponse): string {
        return JSON.stringify(uncast(value, r("SearchImagesResponse")), null, 2);
    }
}
